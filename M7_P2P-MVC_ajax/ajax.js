...
let mis_mangas_iniciales = [
    { titulo: "La chica a la orilla del mar", director: "Inio Asano", "miniatura": "files/orilla.jpg", sinopsis: "Sato e Isobe, dos adolescentes que viven sus días de colegiales en un tranquilo pueblo costero. Ambos deciden embarcarse en una relación puramente física, pero pronto se darán cuenta que dejar de lado los sentimientos resulta muy complicado." },
    { titulo: "Aquella vez que me convertí en Slime", director: "Fuse", "miniatura": "files/slime.jpg", sinopsis: "Satoru Mikami es un hombre de 37 años que tiene un trabajo que no le gusta, sin salida y que no es feliz con la vida que lleva, pero cuando muere a manos de un ladrón y piensa que es su fin, se despierta descubriendo que se ha reencarnado en un mundo de magia y espada… ¡pero como un slime! Ahora tendrá que acostumbrarse a su nueva vida, aunque por suerte contará con dos habilidades únicas que le ayudarán a sobrevivir: una que le proporciona una gran comprensión de todo lo que le rodea, y otra que le permite copiar las habilidades de sus oponentes." },
    { titulo: " A Silent Voice", director: "Yoshitoki Ooima", "miniatura": "files/silent.png", sinopsis: "\“Desearía no habernos conocido nunca. Desearía poder encontrarnos de nuevo.\” La historia gira en torno a Shôko Nishimiya, una estudiante de primaria que es sorda y que al cambiarse de colegio comienza a sentir el bullying de sus nuevos compañeros. Uno de los principales responsables es Ishida Shôya quien termina por forzar que Nishimiya se cambie de escuela. Años después, Ishida busca la redención de sus malas acciones." }
];
...
const indexView = (mangas) => {
    ...
    while (i < mangas.length) {
        view += `
                 <div class="movie">
                    <div class="movie-img">
                         <img class="show" data-my-id="${i}" src="${mangas[i].miniatura}" onerror="this.src='files/placeholder.png'"/>
                    </div>
                    <div class="title">
...
const showView = (mangas) => {
    ...
    <img src="${mangas.miniatura}" class="miniatura_sinopsis" alt="Cubierta de ${mangas.titulo}" onerror="this.src='files/placeholder.png'" >
    <hr>
    <div>
    <h1> ${mangas.titulo} </h1>
