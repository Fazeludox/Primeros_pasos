...
class Game {
    ...
    removeOpponent() {
        ...
        let opponent_dead = document.querySelectorAll(".Opponent");
        setTimeout(() => {
            GAME_UI.gameBoard.removeChild(opponent_dead[0]);
        }, 50);
    }
    ...
    resetGame(getTo){
        ...
        this.lifes = 3;
        document.querySelector('.score .amount').innerHTML = 0;
        ...
        if (!isKeyDown) {
            ...
            switch (event.keyCode) {
                ...
                if(this.paused){
                    ...
                    popUpToggle('modal', 'resume_modal');
                }else{
                    popUpToggle('modal', 'pause_modal');
                }
