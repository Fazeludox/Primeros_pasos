...
const count = () => {
    ...
    result += `Palabras: ${word_array(text).length/*TO DO*/}\n`;
...
const word_index = () => {
    ...
    let ordered_words = text.replace(/[\.,;:()¿?¡!“”❝❞«»❛❜'‘’\-_]+/igm, "").match(/[\wñáéíóúàèìòù]+/gm).map(el => el.toLowerCase()).sort();
